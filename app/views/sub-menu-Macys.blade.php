<div class="pure-menu pure-menu-horizontal">
    ...
    <ul class="pure-menu-list">
        ...
        <li class="pure-menu-item">
            <small><a id="reload" href="{{route('retrieveGetMacysPDF')}}" class="pure-menu-link" style="">Retrieve Packing Lists</a></small>
        </li> <li class="pure-menu-item"><span>|</span></li>
        <li class="pure-menu-item">
            <small><a id="reload" href="{{route('parseGetMacysPDF')}}" class="pure-menu-link" style="">Add Packing Lists to DB</a></small>
 ...
 -->            <span>|</span></li>
        <li class="pure-menu-item">
            <small><a id="" href="{{route('deleteMacysDBForm')}}" class="pure-menu-link" style="">Reset Macys.com DB</a></small>
        </li>
