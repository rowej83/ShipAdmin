...
<head>
    <meta charset="UTF-8">
    <title>Retrieve packinglists from QVC.com POs</title>
...
<div style="width:800px;margin:0 auto;">
    ...
    @endif
    <form class="pure-form" action="retrieveQVCPDF" method="post">
        <div class="pure-g" style="margin:30px;">
            <div class="pure-u-1">
                {{ Form::label('QVCPackingList', 'Packing List POs:', ['class' => 'control-label']) }}<br><br>
                {{ Form::textarea('QVCPackingList') }}
            </div>
        </div>
