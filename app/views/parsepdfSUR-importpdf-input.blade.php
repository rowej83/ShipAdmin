...
<head>
    <meta charset="UTF-8">
    <title>Add Surlatable Packing Slips to DB</title>
...
<div style="width:800px;margin:0 auto;">
    ...
    @endif
    <form class="pure-form" action="parseSURPDF" method="post" enctype="multipart/form-data">
        <div class="pure-g" style="margin:30px;">

            {{ Form::file('SURPackingList[]', ['class' => 'form-control','multiple'=>true]) }}
        </div>
