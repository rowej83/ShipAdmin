...
<head>
    <meta charset="UTF-8">
    <title>Retrieve packinglists from Nordstroms POs</title>
...
<div style="width:800px;margin:0 auto;">
    ...
    <div class="pure-g" style="margin-top:5px;margin-bottom:10px;">
        <div class="pure-u-1">
            <h1>Retrieve PDF from Nordstroms POs
    ...
    @endif
    <form class="pure-form" action="retrieveNORDPDF" method="post">
        <div class="pure-g" style="margin:30px;">
            <div class="pure-u-1">
                {{ Form::label('NORDPackingList', 'Packing List POs:', ['class' => 'control-label']) }}<br><br>
                {{ Form::textarea('NORDPackingList') }}
            </div>
        </div>
