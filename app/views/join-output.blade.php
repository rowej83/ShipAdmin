...
<div style="width:960px;margin:0 auto;">
    ...
    <div class="pure-g" style="margin-top:20px;">
        <div class="pure-g" style="margin-top:20px;margin-bottom:5px;"><div class="pure-u-1">
                <a class="pure-button" href="<?php link_to_route('joinHome');?>">Go back with Input saved to re-Query</a>
            </div>
            <div class="pure-u-1">
    ...
    <div  class="pure-g" style="">
        <div class="pure-u-1">
            ...
            @if(isset($itemCount))
                <div class="pure-u-1"  style="margin-top:10px;"><p id="count" style="word-wrap: break-word;">Total # of items: {{$itemCount}}</p></div>
            @endif
        </div>
    </div>
