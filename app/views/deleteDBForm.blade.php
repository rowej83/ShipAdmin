...
<b style="color:red;">Reset all DB Entries?</b><br><br> Please note: this will NOT delete any entries in your Excel spreadsheet. This will only reset your DB incase it includes any entries from previous spreadsheet loads with bad entries.
        </div>
    </div>
    ...
    <form class="pure-form" action="<?php echo route('deleteDBSubmission'); ?>" method="post">
        <div class="pure-g " style="margin-top:30px;"><div class="pure-u-1-3">
                ...
                <label for="delete" style="display: block;margin-bottom:10px;">Type Y-E-S below to reset your DB.</label>
        ...
        <div class="pure-g" style="margin-top:50px;"><div class="pure-1">   <input type="submit" value="Reset DB" class="pure-button-primary pure-button" style="" class="pure-button"/><input type="button" value="reset" onclick="reset"  id="reset" style="margin-left:10px;" class="pure-button reset"/></div></div>
    </form>
