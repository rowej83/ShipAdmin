...
<head>
    <meta charset="UTF-8">
    <title>Add BBB Packing Slips to DB</title>
...
<div style="width:800px;margin:0 auto;">
    ...
    @endif
    <form class="pure-form" action="parseBBBPDF" method="post" enctype="multipart/form-data">
