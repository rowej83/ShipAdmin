...
<head>
    <meta charset="UTF-8">
    <title>Add Macys Packing Slips to DB</title>
...
<div style="width:800px;margin:0 auto;">
    ...
    <div class="pure-g" style="margin-top:5px;margin-bottom:10px;">
        <div class="pure-u-1">
            <h1>Add Macys.com Packing Slips to DB
                <small style="font-size: .4em;color:grey;"> v1.0</small>
                {{--<small style="margin-left:3px; font-size:.4em;color:grey;">by Jason Rowe</small>--}}
            </h1>
            Instructions: Upload a Macys.com packing slip(s) to add POs to the DB. Can add multiple pdfs at one time.
            <hr>
        </div>
    </div>
    @if(isset($response))
    ...
    <div class="pure-g">
        <div class="pure-u-2-5">
            <form class="pure-form" action="parseMacysPDF" method="post" enctype="multipart/form-data">
