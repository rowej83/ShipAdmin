...
<div class="pure-g" style="margin-top:5px;margin-bottom:10px;">
    <div class="pure-u-1">
        <h1>Parse Chargeback Spreadsheet
            <small style="font-size: .4em;color:grey;"> v1.1</small>
            <small style="margin-left:3px; font-size:.4em;color:grey;">by Jason Rowe</small>
        </h1>
       <small> Instructions: Upload Excel Spreadsheet exported from SAPs' SQ01->ORDER_SHIPPED_INFO to parse Charge Back results.</small></div>
</div>
@if(isset($response))
...
@endif
<form class="pure-form" action="postChargeBack" method="post" enctype="multipart/form-data">
    <div class="pure-g" style="margin:30px;">

        {{ Form::file('chargeBackSpreadSheet', ['class' => 'form-control']) }}
    </div>
